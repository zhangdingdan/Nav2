<template>
     <nav>
        <v-app-bar app flat>
            ...
            <v-spacer></v-spacer>
            <v-btn :to="{name:'Service'}" id="Service" text color="indigo">
                <v-icon>mdi-home</v-icon>
                <span>Service</span>
            </v-btn>

            <v-spacer></v-spacer>
            <v-btn :to="{name:'Security'}" id="Security" text color="indigo">
                <v-icon>mdi-cursor-move</v-icon>
                <span>Security</span>
            </v-btn>

            <v-spacer></v-spacer>
            <v-btn :to="{name:'Transport'}" id="Transport" text color="indigo">
